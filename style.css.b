...
.search-edit, input[type="text"] {
  ...
  .search-edit:hover, input[type="text"]:hover {
    ...
    color: slategray; }
    .search-edit:hover::placeholder, input[type="text"]:hover::placeholder {
      color: #aab8c7; }
  .search-edit::placeholder, input[type="text"]::placeholder {
    font-size: 1em;
    color: #cccccc; }
...
.article-header h1 {
  ...
  font-size: 1.5em;
  color: #222222;
  text-shadow: 1.5px 1.5px 6px whitesmoke; }
